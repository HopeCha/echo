...
import { SidebarGroupLabel, SidebarRail, SidebarTrigger } from "@workspace/ui/components/sidebar";
import {
  CreditCardIcon,
  InboxIcon,
  LayoutDashboardIcon,
            ...
            <SidebarMenuButton asChild size="lg">
              ...
              appearance={{
                elements: {
                  ...
                  organizationSwitcherButton: "group-data-[collapsible=icon]:hidden! ml-auto! text-sidebar-foreground!",
                }
              }}
              />
            </SidebarMenuButton>
